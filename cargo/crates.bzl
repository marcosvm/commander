...
def raze_fetch_remote_crates():
    ...
    maybe(
        http_archive,
        name = "raze__serde_yaml__0_8_21",
        url = "https://crates.io/api/v1/crates/serde_yaml/0.8.21/download",
        type = "tar.gz",
        sha256 = "d8c608a35705a5d3cdc9fbe403147647ff34b921f8e833e49306df898f9b20af",
        strip_prefix = "serde_yaml-0.8.21",
        build_file = Label("//cargo/remote:BUILD.serde_yaml-0.8.21.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.structopt-0.3.23.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.structopt-derive-0.4.16.bazel"),
    )
